...
class CulturalSecretary extends StatefulWidget {
  const CulturalSecretary({super.key});

  @override
  State<CulturalSecretary> createState() => _CulturalSecretaryState();
}

class _CulturalSecretaryState extends State<CulturalSecretary> {
